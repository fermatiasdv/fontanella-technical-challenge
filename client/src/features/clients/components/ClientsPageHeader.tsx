interface ClientsPageHeaderProps { onAddClient?: () => void; }
export function ClientsPageHeader({ onAddClient }: ClientsPageHeaderProps) {
  return (
    <div className="clients-header">
      <div>
        <h2 className="clients-header__title">Clients.</h2>
        <p className="clients-header__subtitle">Manage your firm's professional relationships and upcoming litigation schedules.</p>
      </div>
