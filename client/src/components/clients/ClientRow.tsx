...
// ─── Avatar modifier classes (cycles by index) ────────────────────────────────
    ...
    <tr className="client-row">
      ...
      <td className="client-row__name-cell">
        <div className="client-row__name-wrap">
          <div className={`client-avatar client-avatar${avatarModifier}`}>
            {initials}
          </div>
          <div>
      ...
      <td className="client-row__actions-cell">
        <div className="client-row__actions">
          <button
            ...
            className="client-row__action-btn client-row__action-btn--edit"
            title="Edit"
          >
          ...
          <button
            ...
            className="client-row__action-btn client-row__action-btn--delete"
            title="Delete"
          >
